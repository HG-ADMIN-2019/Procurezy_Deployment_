            ...
            if res[0]:
                if document_number == 'create':
                    response_data = {
                        'res': res[1],
                        'cart_count': res[2],
                        'cart_item_created_at': datetime.datetime.now(),
                        'cart_item_created_by': global_variables.GLOBAL_LOGIN_USERNAME,
                        'cart_item_changed_at': datetime.datetime.now(),
                        'cart_item_changed_by': global_variables.GLOBAL_LOGIN_USERNAME,
                    }
                    # print("Final Response:", response_data)  # Add this print statement
