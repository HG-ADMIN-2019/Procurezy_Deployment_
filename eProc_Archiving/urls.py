...
urlpatterns = [
    ...
    path('detail/<str:type>/<str:guid>', views.m_det_meth, name='doc_details'),                   # Details page
    path('detail/popdf/<str:guid>', views.attachmentspage, name='attach_page'),  # Attachments page
